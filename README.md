...
* [Contenta CMS](https://www.contentacms.org/) – API-First Drupal distribution with multiple with multiple Possibilities/Setups: React + Next / JSON API / static site gen / GraphQL / Ember JS / Angular / gatsby / …
